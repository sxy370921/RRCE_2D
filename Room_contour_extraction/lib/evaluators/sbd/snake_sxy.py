...
class Evaluator:
    def __init__(self, result_dir):
        ...
        # # original version
        # args = DatasetCatalog_sxy.get(cfg.test.dataset)
        # ann_file = 'data/sbd/annotations/sbd_val_instance.json'
        # self.coco = coco.COCO(ann_file)
    
        args = DatasetCatalog_sxy.get(cfg.test.dataset)
        data_source = args['ann_file']
        self.coco = coco.COCO(data_source)
