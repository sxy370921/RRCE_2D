...
class RobotExplorationT0(gym.Env):
    def __init__(self, config_path='config_exploration_segmentation.yaml'):
        ...
        print('\033[1;31;47m Room_Segmentation_GenerationV2 \033[0m')
        self.env_now_num = 0
    ...
    def step(self, action):
        ...
        if self.turn_times > 50:
            ...
            if _crush_ == False:
                ...
                self.turn_times = 0
            # print("\033[32m **Compulsory straight: LEFT {}**\033[0m".format(i))
        if exit_num > 15:
    ...
    def _get_observation_space(self):
        ...
        print('\033[1;31;47m Observation_space: {} \033[0m'.format(obs.shape))
    ...
    def _get_obs(self):
        """
        """
        dst = self.sim.world2state_large_scale()
        dst = dst[:,:,np.newaxis]
